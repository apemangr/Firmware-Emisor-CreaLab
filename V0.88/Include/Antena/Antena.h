...
static void nus_data_handler(ble_nus_evt_t *p_evt)
{
	...
	if (p_evt->type == BLE_NUS_EVT_RX_DATA)
	{
		...
		// 96 envia valores de los adc's y contador
...
static void advertising_init(void)
{
	...
	// Mostrar la cantidad de historiales guardados
	NRF_LOG_RAW_INFO("Cantidad de historiales guardados [%d/%d]\r\n",
					 History_Position, Size_Memory_History);
	NRF_LOG_FLUSH();
	Chip_temperature();
	...
	manuf_specific_data.company_identifier =
		0x1133; // se escribe al revez ... numero de compañia 3322
